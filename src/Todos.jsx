...
const Todos = () => {
    ...
    return (
        <div className='w-full flex gap-2'>
            <div className="todo-Container w-1/2 flex flex-col px-4 pt-10 justify-center overflow-auto" >
                <form onSubmit={handleSubmit} className='w-full p-2 relative flex gap-4'>
                    ...
                    <div className='btns flex gap-3'>
                        <button type="submit" className='outline-none  cursor-pointer rounded p-2 ml-4 bg-green-800 hover:scale-[0.9] ease-in-out'>
                            {editingIndex !== null ? "Update Task" : "Add Task"}
                        </button>

                        <button
                            type="button"
                            className=' outline-none rounded bg-red-800 p-2 ml-2 hover:scale-[0.9] ease-in-out'
                            onClick={() => {
                                setTodo("");
                                setEditingIndex(null);
                            }}
                ...
                <ul className='w-full  p-2' >
                    {todos.length === 0 ? (
                        <p className='text-white'>No tasks yet. Add one !</p>
                    ) : (
            ...
            <div className="w-1/2  flex justify-center items-center px-4 pt-10">
                Timer container
            </div>
